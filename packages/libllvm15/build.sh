...
-DLLVM_ENABLE_PIC=ON
-DLLVM_ENABLE_PROJECTS=clang;clang-tools-extra;compiler-rt;lld;lldb;mlir;openmp;polly;libunwind
...
export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:${TERMUX_PKG_BUILDDIR}"
...
termux_step_host_build() {
	...
	cmake -G 'Unix Makefiles' -DCMAKE_BUILD_TYPE=Release \
		-DLLVM_ENABLE_PROJECTS='clang;compiler-rt;clang-tools-extra;lldb;mlir' $TERMUX_PKG_SRCDIR/llvm
	make -j 1 clang-tblgen clang-pseudo-gen \
